...
import androidx.compose.material.icons.filled.ShoppingCart // Icono para Lista de la Compra
...
sealed class Screen(
    ...
    object News : Screen("news_screen", "Noticias", Icons.Outlined.Article)
    object ShoppingList : Screen("shopping_list_screen", "Lista", Icons.Filled.ShoppingCart) // <-- NUEVA PANTALLA
    ...
    object CreateRecipe : Screen("create_recipe_screen", "Crear Receta")
    object History : Screen("history_screen", "Historial")
...
val bottomNavItems = listOf(
    ...
    Screen.ShoppingList, // <-- AÑADIDA AQUÍ
